...
WebUI.click(findTestObject('Object Repository/Page_flaskBlog/a_Depremler'))

WebUI.setText(findTestObject('Object Repository/Page_Depremler/textarea_DogukanUrker_comment'), 'this is my  first comment')

WebUI.click(findTestObject('Object Repository/Page_Depremler/button_comment'))
